...
function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div
        style={{ y: textY }}
        className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 text-center pt-32 pb-24"
      >
        <motion.h1
          {...fadeUp}
        ...
        >
          We design and deploy AI-powered solutions that automate processes, enhance decision-making, and unlock new business opportunities.
        </motion.p>
        ...
        >
          From conversational AI to advanced machine learning systems, we help businesses harness the full potential of artificial intelligence.
        </motion.p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeUp}>
            ...
            <p className="text-lg text-white/60 leading-relaxed mb-8">
              Artificial Intelligence (AI) refers to systems that can analyze data, learn from patterns, and make decisions with minimal human intervention. These systems process vast amounts of information, recognize patterns, and continuously improve over time.
            </p>

            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: Cpu, name: "Machine Learning" },
                { icon: MessageSquare, name: "Natural Language Processing" },
                ...
                <motion.div
                  ...
                  className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/5 hover:border-primary/20 transition-all group"
                >
            ...
            <p className="mt-8 text-primary/60 text-sm italic border-l-2 border-primary/30 pl-4">
              AI enables machines to simulate human intelligence at scale.
            </p>
          </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 relative z-10">
        <motion.div {...fadeUp} className="text-center mb-16">
          ...
          <p className="text-lg text-white/50 max-w-2xl mx-auto">
            We develop intelligent systems tailored to your business needs, helping you automate workflows, improve accuracy, and deliver better user experiences.
          </p>
        </motion.div>
  ...
  const useCases = [
    {
      ...
      desc: "AI-powered chatbots handle customer queries, automate support, and improve response times across websites and apps.",
      gradient: "from-primary/20 to-amber-500/10",
    },
    {
      icon: Database,
      title: "Retrieval-Augmented Generation (RAG)",
      desc: "RAG systems combine large language models with real-time data retrieval to provide accurate, context-aware responses from your own data sources.",
      gradient: "from-primary/20 to-amber-500/10",
    },
    {
      icon: Sparkles,
      title: "Recommendation Systems",
      desc: "AI suggests products, content, or services based on user behavior and preferences to maximize engagement and revenue.",
      gradient: "from-amber-500/20 to-primary/10",
    },
    {
      icon: FileText,
      title: "Document Processing & Automation",
      desc: "Extract data from invoices, contracts, and forms using AI-powered document understanding and intelligent OCR.",
      gradient: "from-primary/20 to-amber-400/10",
    },
    {
      icon: Eye,
      title: "Computer Vision Applications",
      desc: "Analyze images and videos for object detection, facial recognition, quality control, and visual search.",
      gradient: "from-primary/20 to-amber-500/10",
    },
    {
      icon: BarChart3,
      title: "Predictive Analytics",
      desc: "Forecast trends, customer behavior, and business outcomes using historical data and machine learning models.",
      gradient: "from-primary/15 to-amber-400/10",
    },
  ];
    ...
    <section ref={ref} className="relative py-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 relative z-10">
        <motion.div {...fadeUp} className="text-center mb-16">
          ...
          <p className="text-lg text-white/50 max-w-2xl mx-auto">
            Real-world AI solutions that drive measurable impact across every aspect of your business.
          </p>
        </motion.div>
  ...
  const industries = [
    {
      icon: HeartPulse,
      name: "Healthcare",
      tagline: "Revolutionizing Patient Care with AI",
      points: ["Disease prediction & early diagnosis", "Medical imaging analysis with deep learning", "Virtual health assistants & triage systems"],
      image: "ai-ind-healthcare.webp",
    ...
    },
    {
      icon: Landmark,
      name: "Finance",
      tagline: "Securing & Optimizing Financial Systems",
      points: ["Real-time fraud detection & prevention", "AI-driven risk analysis & modeling", "Algorithmic trading & market prediction"],
      image: "ai-ind-finance.webp",
    ...
    },
    {
      ...
      tagline: "Personalized Shopping Experiences at Scale",
      points: ["Hyper-personalized product recommendations", "Demand forecasting & inventory optimization", "Customer behavior analysis & segmentation"],
      image: "ai-ind-retail.webp",
    ...
    },
    {
      icon: Factory,
      name: "Manufacturing",
      tagline: "Smart Factories Powered by Intelligence",
      points: ["Predictive maintenance & anomaly detection", "Quality inspection using computer vision AI"],
      image: "ai-ind-manufacturing.webp",
    ...
    },
    {
      icon: Truck,
      name: "Logistics",
      tagline: "Intelligent Supply Chain Operations",
      points: ["AI-optimized route planning & delivery", "Supply chain demand forecasting"],
      image: "ai-ind-logistics.webp",
      gradient: "from-primary to-amber-500",
      num: "05",
    },
    {
      ...
      points: ["Personalized learning paths & curricula", "AI tutors & intelligent assessment systems"],
      image: "ai-ind-education.webp",
      gradient: "from-amber-500 to-primary",
      num: "06",
    },
  ];
  ...
  useEffect(() => {
    const unsubscribe = scrollYProgress.on("change", (v) => {
      const index = Math.min(
        Math.floor(v * industries.length),
        industries.length - 1
      );
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-white/30 text-xs uppercase tracking-widest">Industry</p>
              ...
              <div className="lg:col-span-5 hidden lg:flex flex-col items-end justify-center gap-3">
                {industries.map((ind, i) => (
                  <div
                    key={i}
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-500 cursor-pointer w-full max-w-[260px] ${
                      i === activeIndex
                        ? "bg-white/[0.06] border border-primary/30 shadow-[0_0_20px_rgba(255,107,53,0.1)]"
                        : "bg-white/[0.02] border border-white/5 opacity-40 hover:opacity-70"
                    }`}
                  >
                    <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${ind.gradient} flex items-center justify-center flex-shrink-0 ${
                      i === activeIndex ? "shadow-[0_0_12px_rgba(255,107,53,0.3)]" : ""
                    }`}>
                      <ind.icon className="w-4 h-4 text-white" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className={`text-sm font-semibold truncate ${i === activeIndex ? "text-white" : "text-white/50"}`}>
                        {ind.name}
                      </p>
                    </div>
                    <span className={`text-xs font-mono ${i === activeIndex ? "text-primary" : "text-white/20"}`}>
                      {ind.num}
                    </span>
                  </div>
                ))}
...
function GlobalTrendsSection() {
  const trends = [
    {
      ...
      desc: "Tools that create text, images, code, and videos using large language models. Generative AI is reshaping creative workflows, software development, and content production at an unprecedented scale.",
      stat: "85%",
      statLabel: "Enterprise Adoption by 2026",
      highlights: ["Text & Image Generation", "Code Assistants", "Video Synthesis", "Multimodal Models"],
    },
    {
      icon: Satellite,
      title: "Autonomous Systems",
      desc: "Self-driving vehicles, drones, and robotics powered by AI. Autonomous systems are enabling safer transportation, efficient logistics, and next-generation manufacturing with minimal human oversight.",
      stat: "$500B+",
      statLabel: "Market Size by 2030",
      highlights: ["Self-Driving Vehicles", "Autonomous Drones", "Robotic Process Automation", "Smart Navigation"],
    },
    {
      icon: FlaskConical,
      title: "AI in Healthcare Research",
      desc: "Drug discovery, genomics, and precision medicine powered by machine learning. AI is accelerating research timelines from years to months, making treatments more targeted and effective than ever before.",
      stat: "10x",
      statLabel: "Faster Drug Discovery",
      highlights: ["Drug Discovery", "Genomic Analysis", "Precision Medicine", "Clinical Trial Optimization"],
    },
    {
      icon: Building2,
      title: "Enterprise AI Adoption",
      desc: "Businesses integrating AI into operations for automation and decision-making. From intelligent workflows to predictive insights, enterprises are leveraging AI to gain competitive advantages.",
      stat: "72%",
      statLabel: "Companies Using AI",
      highlights: ["Process Automation", "Decision Intelligence", "Customer Experience", "Operational Efficiency"],
    },
    {
      icon: Cloud,
      title: "AI + Cloud Integration",
      desc: "Scalable AI systems powered by cloud infrastructure. Cloud-native AI platforms enable organizations to train, deploy, and scale machine learning models without massive upfront hardware investment.",
      stat: "3x",
      statLabel: "Cloud AI Growth",
      highlights: ["MLOps Pipelines", "Serverless Inference", "Edge AI Deployment", "Auto-scaling Models"],
    },
  ];
  ...
  return (
    <section
      ref={sectionRef}
      className="relative"
      style={{ height: `${trends.length * 100}vh` }}
    >
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="absolute inset-0 bg-[#030318]" />
              ...
              <div className="lg:col-span-7">
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <p className="text-white/55 leading-relaxed text-base mb-10 max-w-xl">
                      {active.desc}
                    </p>
                  ...
                  {trends.map((trend, i) => (
                    <div
                      ...
                      className={`flex items-center gap-4 px-5 py-4 rounded-xl transition-all duration-500 ${
                        i === activeIndex
                          ? "bg-white/[0.06] border border-primary/30 shadow-[0_0_25px_rgba(255,107,53,0.1)]"
                          : "bg-white/[0.02] border border-white/5 opacity-35 hover:opacity-60"
                      }`}
                    >
                      <div className={`w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-amber-500 flex items-center justify-center flex-shrink-0 transition-all ${
                        i === activeIndex ? "shadow-[0_0_15px_rgba(255,107,53,0.3)]" : "opacity-50"
                      }`}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className={`text-xs font-bold ${i === activeIndex ? "text-primary" : "text-white/20"}`}>
                          {trend.stat}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="mt-3 px-5">
                    <div className="h-1 rounded-full bg-white/5 overflow-hidden">
                      <motion.div
                        ...
                        animate={{ width: `${((activeIndex + 1) / trends.length) * 100}%` }}
                        transition={{ duration: 0.4 }}
                      />
                    </div>
                    <p className="text-[10px] text-white/20 mt-2 text-right font-mono">
    ...
    <section ref={ref} className="relative py-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 relative z-10">
        <motion.div {...fadeUp} className="text-center mb-20">
          <p className="text-primary/60 text-xs font-semibold tracking-[0.3em] uppercase mb-4">Our Stack</p>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mb-6">
            Technology Behind{" "}
            <span className="bg-gradient-to-r from-primary to-amber-400 bg-clip-text text-transparent">
              Our AI Solutions
          ...
          <p className="text-lg text-white/40 max-w-xl mx-auto">
            We use industry-leading tools to build scalable and efficient AI systems.
          </p>
        </motion.div>
        ...
        <div className="relative hidden lg:block mb-16">
          ...
          <motion.div
            ...
            className="absolute top-[36px] left-[10%] h-px bg-gradient-to-r from-primary via-amber-500 to-primary origin-left shadow-[0_0_6px_rgba(255,107,53,0.4)]"
          />
              ...
              >
                ...
                <div className="flex flex-col items-center gap-2">
                  {stack.techs.map((tech) => (
                    <span
                      key={tech}
                      className="px-4 py-2 rounded-xl bg-white/[0.03] border border-white/5 text-xs font-medium text-white/50 group-hover:border-primary/15 group-hover:text-white/70 transition-all duration-300 w-full max-w-[140px]"
                    >
                      {tech}
                    </span>
                  ))}
        ...
        <div className="lg:hidden space-y-4">
          {stacks.map((stack, i) => (
            <motion.div
              ...
              className="group p-5 rounded-2xl bg-white/[0.03] border border-white/5 hover:border-primary/20 transition-all"
            >
              ...
              <div className="flex flex-wrap gap-2 ml-16">
                {stack.techs.map((tech) => (
                  <span key={tech} className="px-3 py-1.5 rounded-full bg-primary/5 text-xs font-medium text-primary/60 border border-primary/10">
                    {tech}
                  </span>
                ))}
              </div>
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-16 relative z-10">
        ...
        <div className="relative">
          ...
          <motion.div
            ...
            className="absolute left-8 top-0 w-px bg-gradient-to-b from-primary via-amber-500 to-primary origin-top shadow-[0_0_8px_rgba(255,107,53,0.4)]"
          />
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-16 text-center relative z-10">
        <motion.div {...fadeUp}>
          ...
          <p className="text-lg text-white/50 mb-10 max-w-2xl mx-auto">
            Let's design and deploy intelligent systems that transform your business and unlock new possibilities.
          </p>
